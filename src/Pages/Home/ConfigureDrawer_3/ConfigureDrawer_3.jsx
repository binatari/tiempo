...
import backgroundImage3 from '../../../assets/HomePageImg/ConfigureWatch/configureWatchBg-3.png';
import configureWatch3_41 from '../../../assets/HomePageImg/ConfigureWatch/configureWatch3-41mm.png';
import configureWatch3_36 from '../../../assets/HomePageImg/ConfigureWatch/configureWatch3-36mm.svg';
    ...
    <div className={`h-screen px-20 grid lg:grid-cols-4 grid-cols-1  ${isDark ? 'bg-[#000000]' : ''}`} >
      ...
      <div className="col-span-1 lg:col-span-2 mx-auto lg:my-auto mt-14">
        <div className="relative">
          ...
          <div className=' '>
            <img src={configureWatch3_41} alt="Left" className="py-[63px] md:w-[340px] md:h-[465px] w-[220px] h-[320px] relative" />
          </div>
        </div>
        <div className='w-full text-center md:py-14 py-3'>
          <button className='lg:text-[18px] text-[14px] uppercase  bg-gray-200 hover:bg-white/70 hover:text-black lg:px-7 lg:py-3 px-5 py-2 rounded-full text-black border border-[#C7C7C7]' onClick={handleImagesData}>Start</button>
        </div>
      ...
      <div className="col-span-1  mx-auto my-auto">
        <div className="relative">
          <img src={configureWatch3_36} alt="watchImg" className="lg:w-full lg:h-full lg:mt-14  md:w-48 h-48" />
...
export default ConfigureDrawer_3