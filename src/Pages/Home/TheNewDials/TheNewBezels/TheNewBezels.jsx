...
const TheNewBezels = () => {
  ...
  return (
    <div className=" w-10/12 lg:w-3/4 mid-xl:w-8/12 mx-auto xl:mt-40 ">
      <div className="py-10">
        <h1
          className={`text-center mid-xl:text-[30px] lg:text-[27px] md:text-[24px] text-[21px] uppercase ${
      ...
      <div className="grid lg:grid-cols-2 justify-center items-center gap-10">
        <div className="">
          <h1
            className={`md:text-[20px] text-[18px]  uppercase ${
              isDark ? "text-white" : "text-black"
            }`}
          >
            Bezels
          ...
          <p
            className={`${
              isDark
                ? "text-[#8C8C8C] md:text-[17px] lg:text-[19px] text-[14px] text-justify"
                : "text-[#474A59]"
            } leading-[23.7px] md:text-[17px] lg:text-[19px] text-[14px] pt-4 text-justify`}
          >
