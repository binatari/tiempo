  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute md:bottom-14 mid-sm:bottom-14 lg:bottom-5 xl:bottom-0 mid-xl:bottom-14 left-5 right-0 flex  justify-center items-center z-20  ${isDark ? "text-[#A6A6A6]" : "text-black"
            }`}
        >
